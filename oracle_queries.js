            ...
            switch (nconsulta) {
                ...
                case "portabilidad_operador_out":
                    query = "select A.* from (" +
                        ...
                        `AND TRUNC(FECHA_PROCESO) = TO_DATE('15/02/2020','DD/MM/YYYY')),1) PORCENTAJE,` + //fecha estática para pruebas, borrar o comentar cuando el sistema este con datos actuales
